...
const Product = ({ product }) => {
    ...
    return (
        <div className="rounded-lg shadow-md shadow-slate-950 bg-blend-multiply hover:shadow-2xl hover:-translate-y-3 duration-300">
            <div>
                <img className="object-fill h-48 w-96 rounded-lg" src={img} alt={img} />
            </div>
            ...
            <div onClick={() => navigate(`/product/${_id}`)} className="text-center text-slate-200 font-semibold btn-grad">
